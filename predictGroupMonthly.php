...
<html lang="en">
<head>
<title>Predicted Group Item Sales of upcoming month</title>
	<meta charset="utf-8">
...
<div class="px-4">
<?php
	echo "<h1>Predicted sales of groups of items for next month</h1>";
		...
		if(mysqli_num_rows($sql1) > 0)
			{
			 ...
			 { 
				...
				INNER JOIN item ON invoicedetail.ItemID = item.ItemID WHERE DATE_SUB(CURDATE(),INTERVAL 90 DAY) <= InvoiceDate AND item.ItemCategory = '$Category'";
				...
				$categoryTotalQuantity = $categoryTotalQuantity / 3;
				$categoryTotalSales = $categoryTotalSales / 3;
